...
export const CLIENTS = [
  ...
  },
  {
    ...
    sickDaysBalance: 320,
    vacationDaysBalance: 140,
    estimatedRetirementDate: 'December 2026',
    policyChangeImpact: '',
  },
  {
    id: 'patricia',
    name: 'Patricia Chen',
    age: 42,
    department: 'Sacramento County Public Works',
    yearsOfService: 16,
    retirementEligibility: '9 years',
    scenario: 'benefit_review',
    scenarioLabel: 'Annual Benefit Review',
    status: 'active' as const,
    phone: '(916) 555-0445',
    ...
    sickDaysBalance: 145,
    vacationDaysBalance: 85,
    estimatedRetirementDate: 'April 2035',
    policyChangeImpact: '',
  },
  {
    id: 'robert',
    ...
    yearsOfService: 24,
    retirementEligibility: '1 year',
    scenario: 'policy_concern',
    scenarioLabel: 'Policy Change Concern — Early Retirement',
    status: 'flagged' as const,
    phone: '(510) 555-0678',
    state: 'California',
    county: 'Alameda County',
    sickDaysBalance: 280,
    vacationDaysBalance: 110,
    estimatedRetirementDate: 'September 2027',
    policyChangeImpact: 'Affected by early retirement penalty adjustments',
  },
  {
    id: 'jennifer',
    name: 'Jennifer Patel',
    age: 36,
    department: 'Santa Clara County Social Services',
    yearsOfService: 8,
    retirementEligibility: '17 years',
    scenario: 'enrollment_update',
    scenarioLabel: 'Beneficiary Enrollment Update',
    status: 'active' as const,
    phone: '(408) 555-0234',
    ...
    sickDaysBalance: 72,
    vacationDaysBalance: 48,
    estimatedRetirementDate: 'May 2043',
    policyChangeImpact: '',
  },
  {
    id: 'michael',
    ...
    age: 47,
    department: 'Ventura County Sheriff Department',
    yearsOfService: 19,
    retirementEligibility: '6 years',
    scenario: 'benefit_review',
    scenarioLabel: 'Annual Benefit Review',
    status: 'active' as const,
    phone: '(805) 555-0567',
    ...
    sickDaysBalance: 175,
    vacationDaysBalance: 95,
    estimatedRetirementDate: 'January 2032',
    policyChangeImpact: '',
  },
  {
    id: 'lisa',
    name: 'Lisa Nguyen',
    age: 44,
    department: 'Contra Costa County Health Services',
    yearsOfService: 14,
    retirementEligibility: '11 years',
    scenario: 'benefit_review',
    scenarioLabel: 'Annual Benefit Review',
    status: 'active' as const,
    phone: '(925) 555-0789',
    ...
    sickDaysBalance: 130,
    vacationDaysBalance: 70,
    estimatedRetirementDate: 'July 2037',
    policyChangeImpact: '',
  },
  {
    id: 'david',
    name: 'David Kim',
    age: 51,
    department: 'Fresno County Probation Department',
    yearsOfService: 21,
    retirementEligibility: '4 years',
    scenario: 'policy_concern',
    scenarioLabel: 'Policy Change Concern — Final Compensation',
    status: 'flagged' as const,
    phone: '(559) 555-0912',
    state: 'California',
    county: 'Fresno County',
    sickDaysBalance: 195,
    vacationDaysBalance: 105,
    estimatedRetirementDate: 'November 2030',
    policyChangeImpact: 'Affected by final compensation averaging period changes',
  },
  {
    id: 'angela',
    name: 'Angela Brown',
    age: 39,
    department: 'San Bernardino County District Attorney',
    yearsOfService: 12,
    retirementEligibility: '13 years',
    scenario: 'enrollment_update',
    scenarioLabel: 'Beneficiary Enrollment Update',
    status: 'active' as const,
    phone: '(909) 555-0345',
    ...
    sickDaysBalance: 110,
    vacationDaysBalance: 65,
    estimatedRetirementDate: 'March 2039',
    policyChangeImpact: '',
  },
];
